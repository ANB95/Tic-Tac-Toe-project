...
public class Game {
	...
	private void winGame() 
	{
		...
		if (b1=="X" && b2=="X" && b3=="X")
		{
			JOptionPane.showMessageDialog(frame, "Player X wins", "Tic-Tac_Toe", JOptionPane.INFORMATION_MESSAGE);
			xCount++;
			gameScore();
		}
		if (b4=="X" && b5=="X" && b6=="X")
	...
	private void initialize() {
		...
		txtCountX.setFont(new Font("Tahoma", Font.BOLD, 44));
		txtCountX.setText("0");
		...
		txtCountO.setFont(new Font("Tahoma", Font.BOLD, 44));
		...
		btnReset.setFont(new Font("Tahoma", Font.BOLD, 46));
